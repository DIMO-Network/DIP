...
> **Status**: Deployed
>
> **Voting URL**: [Snapshot](https://snapshot.box/#/s:dimo.eth/proposal/0x8e7a5bcfcc0dcfd695189c950c46fd6c108476fdceb56de8c00c8a0fed9cbde4)
>
...
The DIMO Foundation is authorized to spend a maximum of $6,768,000 USD equivalent on operations and development in the calendar year 2025. Note that this is an expense budget only and [revenue](dip3-and-10a1.md) may decrease or entirely erase the net operating loss.
...
This expense budget line item is only unlocked if [DIP-3 Amendment 2](dip3-and-10a1.md) passes, as this proposal requires applications, such as DIMO Mobile, to pay per month to access vehicles. _These fees could partially or entirely offset this expense._
