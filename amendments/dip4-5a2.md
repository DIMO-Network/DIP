...
>
> **Status**: Voting (until July 22nd, 2024 at 16:27:00 UTC)
>
...
<mark style="color:red;">Developers</mark>~~<mark style="color:red;">Data Subscribers</mark>~~ are entities that offer services to users (e.g., a refinancing app) and/or pay users for data (e.g., an electric vehicle R\&D company). Developers must pay 100,000 DIMO Credits (DCX), which is equivalent to $100 USD, to acquire a developer license.
