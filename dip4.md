...
Licenses are NFTs that can only be minted or transferred by DIMO Integrations. These certify the integration provider meets all required qualifications required and has been whitelisted for the production of compatible devices. After receiving a license, the integration provider is required to submit a deposit of 100,000 $DIMO tokens (the “bond”). For more on how this works, see [License](http://127.0.0.1:5000/s/fmY0p4toAb7e89toAV2R/identity-protocol/nodes-and-nfts/license "mention").
